...
#Given the R-squared value, around virtually none of the variability in total
...
#p-value = 0.9239)
#Note that we can this single regression can also be applied to "# of years a
...
#governors.
#See the below plots of these regressions which help to numerical outputs and
#write-ups above.
...
#the null hypothesis (that there is no correlation). Thus, it appears that
