...
#States_shapefile_csv <- read.csv("Data/Raw/States_shapefile.csv")

#States_shapefile_shp <- st_read("Data/Raw/States_shapefile.shp")

States_shapefile_shp <- st_read("Data/Raw/us-state-boundaries.shp")

States_shapefile_csv <- read.csv("Data/Raw/us-state-boundaries.csv")

counties_sf_1 <- st_read('Data/Raw/cb_2018_us_county_20m.shp')
